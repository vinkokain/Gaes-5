...
<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
            ...
            <form>
                ...
                int docUsu=Integer.parseInt((String)request.getAttribute("editarid"));            
                Usuario u = (Usuario) dao.list(docUsu);
            %>
                <div class="row">
                    <div class="col">
                        <label for="">Numero de documento <span class="red">*</span></label>
                        <input  name="usuId" value="<%= u.getDocUsu() %>" type="number" class="form-control" required>
                    </div>

                    <div class="col">
                        <label for="numeroderuc">Tipo de documento</label>
                        <select name="usuTipDoc" value="<%= u.getTipoDocUsu() %>" type="text" class="form-select" aria-label="Seleccione una opción">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input name="usuNombre" value="<%= u.getNombreUsu() %>" type="text" class="form-control" required>
                     </div>
                    <div class="col">
                        <label for="">Apellidos del usuario </label>
                        <input name="usuApellido" value="<%= u.getApellidoUsu() %>" type="text" class="form-control" required>
                    </div>
                </div><br><br>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input name="usuTel1" value="<%= u.getTelUnoUsu() %>" type="text" class="form-control" required>
                    </div>
                    <div class="col">
                        <label for="">Tel/cel acudiente<span class="red">*</span></label>
                        <input name="usuTel2" value="<%= u.getTelDosUsu() %>" type="text" class="form-control" required>
                    </div>
                </div><br><br>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input name="usuCorreo" value="<%= u.getCorreoUsu() %>" type="email" class="form-control" required>
                    </div>
                    <div class="col">
                        <label for="">Genero de nacimiento<span class="red">*</span></label>
                        <select name="usuSexo" value="<%= u.getSexoUsu() %>" type="text" class="form-select" aria-label="Seleccione una opción">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <select name="rolUsuario" value="<%= u.getRolUsu() %>" type="text" class="form-select" aria-label="Seleccione una opción">
                    ...
                    <div class="col">
                        ...
                        <input name="usuClave" value="<%= u.getClaveUsu() %>" type="password" class="form-control" required>
                    </div>
                </div><br><br>
                ...
                <div class="row text-center">
                    ...
                    <p class="col text-center">
                        <button type="submit" class="btn btn-primary mb-2"name="accion" value="Actualizar">Enviar</button>
                    </p>
                </div>
