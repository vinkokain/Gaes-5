	...
	<section class="full-box cover dashboard-sideBar">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-city-alt zmdi-hc-fw"></i> Administración <small>Categoria</small></h1>
		...
		<div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel-heading" style="background:#63B840">
					<h3 class="panel-title" ><i class="zmdi zmdi-plus"  ></i> &nbsp; EDITAR CATEGORIA</h3>
				</div>
            ...
            <%
                ...
                int id=Integer.parseInt((String)request.getAttribute("editarid"));            
          ...
          <div class="row" >
				    				<div class="col-xs-12 col-sm-6">
								    	<div class="form-group label-floating">
										  	...
										  	<input pattern="[0-9-]{1,30}" class="form-control" name="txtid" value="<%= c.getId()%>" type="number" required="" maxlength="10">
										</div>
									</div>
				    				...
				    				<div class="col-xs-12 col-sm-6">
								    	<div class="form-group label-floating">
										  	...
										  	<input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="txtnombre" value="<%= c.getNombre()%>" type="text" required="" maxlength="40">
										</div>
				    				</div>
					    ...
					    <input class="btn btn-warning btn-raised btn-sm" type="submit" name="accion" value="Actualizar">
                                <a class="btn btn-dark btn-raised btn-sm" href="CategoriaControlador?accion=listar">Regresar</a>
