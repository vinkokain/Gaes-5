   ...
   <section class="full-box dashboard-contentPage"  >
		...
		<div class="container-fluid">
			<div class="page-header" >
			  <h1 class="text-titles"><i class="zmdi zmdi-balance zmdi-hc-fw"></i> Administración <small>Categoria</small></h1>
			</div>
		...
		<div class="container-fluid">
			<div class="panel panel-success">
				<div class="panel-heading" >
					<h3 class="panel-title"><i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; LISTA DE CATEGORIAS</h3>
				</div>
				<div class="panel-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
				<a href="CategoriaControlador?accion=editar&id=<%= cat.getId()%>" class="btn btn-success btn-raised btn-xs">
					<i class="zmdi zmdi-refresh"></i>
				</a>
			</td>
			<td>
				<a href="CategoriaControlador?accion=eliminar&id=<%= cat.getId()%>" type="submit" class="btn  btn-raised btn-xs"> <!-- btn-danger -->
